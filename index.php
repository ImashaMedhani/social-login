...
<!--<![endif]-->
 ...
 <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.1/css/bootstrap.min.css" integrity="sha384-WskhaSGFgHYWDcbwN70/dfYBj47jz9qbsMId/iRN3ewGhXQFZCSftd1LZCfmhktB" crossorigin="anonymous">
    <body style="height: 100% ; background-image: url(https://www.hd-wallpapersdownload.com/script/bulk-upload/background-pictures-for-computer-screen-hd-wallpaper.jpg); ">
    <div class="container" style="margin-top: 100px">
        <div class="row justify-content-center">
            <div class="col-md-6 col-md-offset-3" align="center">
                <img src="" style="margin-bottom: 20px"><br>
                <form>
    ...
    <br>
		...
		<?php
			...
			if ($gClient->getAccessToken()) 
			{
				...
				$output= '<a href="'.filter_var($authUrl, FILTER_SANITIZE_URL).'"><img src="images/g+.png" class="img-rounded" style="display:block; margin-left:auto;margin-right:auto;width:300px;border-radius:5px;" /></a>';
			}
			echo $output;
		?>
	</body>
